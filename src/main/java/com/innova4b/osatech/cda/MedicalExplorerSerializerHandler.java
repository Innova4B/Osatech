...
public class MedicalExplorerSerializerHandler implements SerializerHandler{
	...
	private static final String TAG_HISTORY_NUM			= "Nº HISTORIA:";
	private static final String TAG_BIRTH_DATE			= "F. NACIMIENTO:";
	...
	private static final String TAG_MEDICATION 			= "MEDICACIÓN HABITUAL:";
	private static final String TAG_SOCIAL_HISTORY 		= "HÁBITOS TÓXICOS:";
	...
	private static final String TAG_REASON_ASSESSMENT	= "MOTIVO:";
	private static final String TAG_EXAMINATION 		= "EXPLORACIONES:";
	...
	public MedicalExplorerSerializerHandler() {
	...
	public String serialize(InputStream is) throws Exception {
		Scanner scan = new Scanner(is, "ISO-8859-15");
		String namespace = "";
	...
	public void process(String line) 
		...
		if (line.startsWith(TAG_PATIENT)) {
			...
			//NOT PROCESSED
		} else if (line.startsWith(TAG_VISIT_DATE)) {
			line = line.replace(TAG_VISIT_DATE, "").trim();
	...
	private void addNotes(String namespace, String text) 
			throws IllegalArgumentException, IllegalStateException, IOException {
